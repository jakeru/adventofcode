...
# 07:10: p1 solved
# p2 solved later during the day
#
# Inital implementation for p1 was a using a list.
# For p2 this was changed to a double linked list in order to solve it within
# reasonable time.
